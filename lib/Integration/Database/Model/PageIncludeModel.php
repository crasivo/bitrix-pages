 ...
 * @internal
 */
class PageIncludeModel extends \Crasivo\Pages\Domain\Model\PageIncludeModel implements Arrayable
{
    /**
     * @param array $row
     * @return self
    ...
    public static function fromOrmData(array $row): self
    {
        ...
        $model->setIncludePath((string)$row[PageRouteTable::COLUMN_INCLUDE_PATH]);
    ...
    public function toOrmData(): array
    {
        return [
            ...
            PageRouteTable::COLUMN_INCLUDE_PATH => $this->getIncludePath(),
        ];
    }
}