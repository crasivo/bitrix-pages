 ...
 * @internal
 */
class PageRedirectModel extends \Crasivo\Pages\Domain\Model\PageRedirectModel implements Arrayable
{
    /**
     * @param array $row
     * @return self
    ...
    public static function fromOrmData(array $row): self
    {
        ...
        $model->setRedirectUrl((string)$row[PageRouteTable::COLUMN_REDIRECT_URL]);
    ...
    public function toOrmData(): array
    {
        return [
            ...
            PageRouteTable::COLUMN_REDIRECT_URL => $this->getRedirectUrl(),
        ];
    }
}
