 ...
 * @internal
 */
class PageComponentModel extends \Crasivo\Pages\Domain\Model\PageComponentModel implements Arrayable
{
    /**
     * @param array $row
     * @return self
    ...
    public static function fromOrmData(array $row): self
    {
        ...
        $model->setComponentName((string)$row[PageRouteTable::COLUMN_COMPONENT_NAME]);
        $model->setComponentParams((array)$row[PageRouteTable::COLUMN_COMPONENT_PARAMS]);
        $model->setComponentTemplate((string)$row[PageRouteTable::COLUMN_COMPONENT_TEMPLATE]);
    ...
    public function toOrmData(): array
    {
        return [
            ...
            PageRouteTable::COLUMN_COMPONENT_NAME => $this->getComponentName(),
            PageRouteTable::COLUMN_COMPONENT_PARAMS => $this->getComponentParams(),
            PageRouteTable::COLUMN_COMPONENT_TEMPLATE => $this->getComponentTemplate(),
        ];
    }
}
