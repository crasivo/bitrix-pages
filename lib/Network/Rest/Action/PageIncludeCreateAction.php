...
use Crasivo\Pages\Domain\Api\CreatePageInclude;
...
use Crasivo\Pages\Network\Shared\Request\PageIncludeCreateRequest;

/**
 * @final
 * @internal
 * @restUrl /rest/crasivo:pages.route.createInclude
 */
class PageIncludeCreateAction extends Action
{
     ...
     *
     * @param PageIncludeCreateRequest $requestData
     * @return mixed
     * @throws \Throwable
     */
    public function run(
        PageIncludeCreateRequest $requestData,
    )
    {
        ...
        $pageRoute = $serviceLocator
            ->get(CreatePageInclude::class)
            ->do(new RawPageInclude(
