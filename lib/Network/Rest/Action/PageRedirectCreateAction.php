...
use Crasivo\Pages\Domain\Api\CreatePageRedirect;
 ...
 * @final
 * @internal
 * @restUrl /rest/crasivo:pages.route.createRedirect
 */
class PageRedirectCreateAction extends Action
{
     ...
     *
     * @param PageRedirectCreateRequest $requestData
     * @return mixed
     * @throws \Throwable
     */
    public function run(
        PageRedirectCreateRequest $requestData,
    )
    {
        ...
        $pageRoute = $serviceLocator
            ->get(CreatePageRedirect::class)
            ->do(new RawPageRedirect(
